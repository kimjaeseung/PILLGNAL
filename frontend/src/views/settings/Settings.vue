      ...
      <v-row class="mt-12">
        ...
        <v-col>
          ...
          <v-card @click="router(3)" outlined class="text-center">
            <v-avatar class="mt-7" tile
              ><img src="@/assets/settings/attention.svg"
            /></v-avatar>
